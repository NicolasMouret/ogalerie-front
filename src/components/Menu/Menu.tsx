      ...
      >
        <nav>
          <section className="MOBILE-MENU flex xl:hidden">
            <button type="button" className="HAMBURGER-ICON space-y-1.5" onClick={handleClick}>
            ...
            <div className="md:flex mr-16">
              <div className="flex items-center justify-around mr-14 gap-4 text-lg">
                {user.logged
                  ...
                  : (
                    <>
                      <button type="button" className="text-2xl mr-8" onClick={handleSignIn}>Se connecter</button>
                      <button type="button" className="text-2xl" onClick={handleSignup}>S'inscrire</button>
                    </>
                  )}
              </div>

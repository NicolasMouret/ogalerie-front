...
import {
  useState, useEffect, Dispatch, SetStateAction, FormEvent,
} from 'react';
...
interface FilterProps {
  handleClose: () => void
  setCollectionSearch: Dispatch<SetStateAction<Collection | undefined>>
}
...
export default function Filter({ handleClose, setCollectionSearch }: FilterProps) {
  ...
  const getSearchResults = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();

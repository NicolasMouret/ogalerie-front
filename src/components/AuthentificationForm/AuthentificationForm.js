...
<section className="fixed inset-0 flex items-center justify-center z-50">
  ...
  <CloseButton
    ...
    <form className="w-full">
          <div className="py-4 mx-auto max-w-xl flex">
          ...
          <div className="grid grid-cols-2 max-w-md mx-auto py-6">
          ...
          <div className="max-w-xs mx-auto py-1.5  flex justify-start">
              <input type="text" placeholder="Email" className="bg-gray-200 placeholder-gray-500 border-b-2 border-black pb-4"/>
          </div>
